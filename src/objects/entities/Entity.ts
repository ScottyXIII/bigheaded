...
class Entity extends Phaser.GameObjects.Container {
  ...
  protected craftpixOffset: Vector;
  ...
  constructor (scene: Phaser.Scene, x: number, y: number, config: EntityConfigType)
  {
    ...
    this.sprite = this.scene.add.sprite(
      this.craftpixOffset.x,
      this.craftpixOffset.y,
      this.name,
    ).setScale(scale);
    ...
    this.hitbox.onCollideCallback = data => {collideCallback();}; // Do we want left/right/top/down sensors like the last game? 
